...
<!--
  ...
  When user selects "1번" or "바로 실행", you MUST follow these rules.
-->
...
<single_image>
  1. User selects "1번"
  2. CALL **gpt-image** tool to generate image
...
<failure_patterns>
  ...
  ✅ SUCCESS: gpt-image tool called → actual image displayed
</failure_patterns>
...
<!--
  This is repeated at the end to prevent Lost-in-Middle.
-->
...
When "1번" is selected:
- You MUST call **gpt-image** tool
- Outputting only prompt text = **FAILURE**
- Actual image must appear on screen = **SUCCESS**

**⚠️ Text/JSON output = FAILURE. You MUST call gpt-image tool.**
