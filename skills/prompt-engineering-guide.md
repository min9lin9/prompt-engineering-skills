...
| **Compaction** | GPT-5.2 | 대화 내용을 요약해서 토큰을 절약하는 기능 |
...
Nano Banana (Gemini 2.5 Flash Image)는 Gemini의 네이티브 이미지 생성 모델입니다. Veo 동영상의 시작 프레임이나 참조 이미지로 활용할 수 있습니다.
